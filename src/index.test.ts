...
describe('index', () => {
    ...
    describe('2576', () => {
        ...
        it('should segment the pages', () => {
            ...
            testSegment(segments[2], {
                endsWith: 'على الدوام، آمين.',
                from: 3,
                startsWith: 'فإنهم بذلوا',
                to: 4,
            });
    ...
    describe('2588', () => {
        ...
        it.only('should segment the pages', () => {
            data = {
                ...
                pages: [
                    {
                        content:
                            'المغْني\rلمُوَفَّق الدين أبي محمد عبد اللَّه بن أحمد بن محمد بن قُدامة\rالمقْدسيّ الجَمَّاعِيليّ الدِّمَشْقيّ الصَّالحِيّ الحَنْبَلِيّ\r(٥٤١ - ٦٢٠ هـ)\rتحقيق\rالدكتور\rعبد اللَّه بن عبد المحسن التركي\rالدكتور\rعبد الفتاح محمد الحلو\rالجزء الأول\rدَار عَالَم الكُتبُ\rللطباعة والنشر والتوزيع\rالرياض',
                        id: 1,
                    },
                    {
                        content: 'المغْني',
