...
// Canonical stoplist only. The helper already normalizes Arabic diacritics and
// equivalent letters for stopword matching, so clients do not need to provide
// every vocalized variant separately.
const ARABIC_DICTIONARY_STOP_WORDS = [
    'أخاك',
    'أراد',
    'أقول',
    'أما',
...
const ARABIC_DICTIONARY_PAGE_START_PREV_WORD_STOPLIST = [
    'قال',
    'وقال',
    'وقيل',
    'جل',
    ...
    describe('2553', () => {
        beforeEach(() => {
            pages = [
                {
                    content:
                        '<span data-type="title" id=toc-18>باب العين والزاي (ع ز، ز ع مستعملان)</span>\rعز: العزَّة لله تبارك وتعالى، والله العزيز يُعِزُّ من يشاء ويُذِلُّ من يشاء. من اعتَزَّ بالله أعزَّه الله ويُقال: عزَّ الشيء، جامِعٌ «١» لكلّ شَيء إذا قلَّ حتى يكادُ لا يُوجدُ من قلَّته يَعِزُّ عِزَّة، وهو عزيز بَيَّنُ العَزازة، ومُلْك أعَزُّ أي عزيز، قال الفرزدق:\rإنّ الذي سمك السَّماء بنى لنا ... بَيْتا دَعائمُهُ أعَزُّ وأطوَلُ\rوالعزَّاءُ: السَّنة الشَّديدةُ، قال العجَّاجُ: «٢»\rويَعْبِطُ الكُوم في العَزَّاءِ إن طُرِقَا\rوقيل: هي الشدة والعَزُوزُ: الشاةُ الضيِّقةُ الإحْليل التي لا تدرُّ بحلبة فتحلُبُها بجَهْدِك «٣» ويقال: قد تعزَّزتْ. وعَزَّ الرجُلُ: بلغ حدَّ العِزَّة ويقال: إذا عزَّ أخوك فهُنْ. واعتزَّ بفلان: تشرَّفَ به والمُعازَّةُ: المُغالَبة في العِزِّ. وقوله تعالى: وَعَزَّنِي فِي الْخِطابِ\r«٤» أي غلبني، ويقال أعزِز عليَّ بما أصاب فلانا أي أعظم «٥» عليَّ، ولا يقال: أعززت.',
                    id: 66,
                },
                {
                    content:
                        'والمطر يُعَزِّز الأرض تَعزيزاً إذا لَبَّدَها. ويقالُ للوابل إذا ضرب الأرض السَّهْلَةَ فشدَّدها حتى لا تسُوخ فيها الرِجْل: قد عزَّزها وقد أعْزَزْنا فيها: أي وَقَعْنا فيها. والعَزاز: أرض صُلْبة ليست بذات حجارة، لا يعلوها الماء، قال الراجز:\rيرْوي العَزازَ أيُّ سَيْلٍ فائِضٍ «١»\rوقال العجاج:\rمن الصَّفا القاسَي «٢» ويَدْعَسْنَ الغُدُرْ ... عزازه ويهتمِرْن «٣» ما انْهَمَرْ\rزع: الزَّعْزَعَةُ: تحريك الشيء لتَقْلَعَهُ وتُزِيلهَ. (زَعْزَعَه زَعْزَعَةً فَتَزَعْزَعَ) «٤» والرِّيحُ تُزَعْزِعُ الشَّجر ونحوه، قال: «٥»\rفو اللهِ لولا اللهُ لا شيء «٦» غَيْرُه ... لُزعْزِع من هذا السرير جوانبه',
                    id: 67,
                },
                {
                    content:
                        'والعُلْعُلُ: اسمُ الذَّكر، وهو رأْسُ الرَّهابة أيضاً، والعَلْعَالُ: الذَّكرُ من القنابر. ويقال: عَلَّ أخاك: أي لعلَّ أخاك، وهو حرْفٌ يُقِّربُ من قضاء الحاجة ويُطْمِعُ، وقال العجاج:\rعَلَّ الاله الباعِثَ الأثقالا ... يُعْقِبني مِن جَنَّةٍ ظِلاَلا\rويقالُ: لعلَّني في معنى لعلِّي قال: «١»\rوأُشْرِف من فَوْقِ البطاح لعلَّني ... أرى نار ليْلي أو يراني بصيرها\rلع: قال زائدةُ: جاءت الإبلُ تُلَعْلِعُ في كلأٍ خفيفٍ أي تَتْبعُ قليلةً. وتُلَعْلَعُ وتُلَهْلِهُ واحدٌ. واللُّعْلَعُ: السَّاب نفسه. واللَّعْلَعَةُ: بصيصه. والتَّلَعْلُعُ: التَّلأْلُؤُ. والتَّلَعْلُعُ: التَّكَسُّرُ، قال العجاج: «٢» .\rومن هَمَزْنا رأسَهُ تَلَعْلَعَا\rواللُّعَاعُ: ثمرُ الحشيش الذي يُؤْكَلُ والكلب يَتَلَعْلَعُ إذا دَلَعَ لسانُه من العطش ورجُل لَعَّاعَة: يَتَكَّلفُ الألحان من غير صواب وامْرأةٌ لَعَّةٌ: عفيفةٌ مليحه. ولَعْلَعٌ: مَوضِع قال: «٣»\rفَصَدّهُم عن لَعْلَعِ وبارِقِ ... ضَرْبٌ يشظيهم على الخنادق',
                    id: 79,
                },
                {
                    content:
                        '<span data-type="title" id=toc-27>باب العين والنون (ع ن، ن ع مستعملان)</span>\rعن: العُنَّةُ: الحَظِيرةُ (من الخشب أو الشجر تُعْمَلُ للإبل أو الغنمِ أو الخيْلِ تكون على باب الرَّجُل) «١» . والجمع العُنَن، قال الأعشى:\rترى اللَّحْمَ من ذابلٍ قد ذوى ... ورطْبٍ يُرَفَّعُ فوْق العُنَنْ\rوعَنَّ لنا كذا يَعِنُّ عَنَناً وعُنُونا: أي ظهر أمامنا. والعَنُونُ من الدوابِّ: المتقدِّمةُ في السَّيْر، قال النابغة:\rكأنَّ الرّحْل شُدَّ به خنوف ... «٢» من الحونات هادئة عَنُونُ\rورجُلٌ عِنِّين: وهو الذي لا يَقْدِرُ أن يَحْبِسَ رِيحَ نَفْسه وتقول: إنَّه ليأخذُ في كُلِّ فَنٍِّ وسَنٍٍّ وعَنٍِّ بمعني واحد. والعِنانُ من الِّلجَام: السَّيْرُ الذي بيدِ الفارس الذي يُقَوِّمُ به رأس الفرس، ويُجْمع على أَعِنَّة وعُنُن «٣» . وعَنانُ السَّماءِ: ما عنَّ لك منها أي: بدا لك إذا نظرت إليها، ويقال: بل عَنانُ السَّماءِ: السَّحاب، الواحدة عَنانَةٌ، ويُجمعُ على أعنانٍ وعنانٍ، قال الشَّماخ:\rطوى ظمْأها في بيضة الصيف «٤» بعد ما ... جرت في عنانِ الشِّعْرَيين الأماعِزُ\rويقال: أعنانُ السَّماء: نواحيها. وعَنَنْتُ الكتاب أعُنُّهُ عناًّ وَعَنْوَنْتُ وعَنْوَيتُ عَنْوَنَةً وعنوانا.',
                    id: 80,
                },
            ];
        ...
        it('should segment dictionary pages with chapter and entry rules while avoiding known false positives', () => {
            const segments = segmentPages(pages, options);
            const chapterSegments = segments.filter((segment) => segment.meta?.type === 'chapter');
            const entrySegments = segments.filter((segment) => !segment.meta?.type);
            const entryHeads = entrySegments.map((segment) => segment.content.split(/\s+/u, 1)[0]);
            const entryLemmas = entrySegments.map((segment) => segment.meta?.lemma);

            expect(chapterSegments).toHaveLength(2);
            expect(chapterSegments[0].content).toStartWith('باب العين والزاي');
            expect(chapterSegments[1].content).toStartWith('باب العين والنون');

            expect(entryHeads).toEqual([
                'عز:',
                'والعزَّاءُ:',
                'والعَزُوزُ:',
                'والمُعازَّةُ:',
        ...
        it('should not cut on al-Layth', () => {
            initPages([
                'أَبُو عبيد عَن الْأَصْمَعِي: البضيع: الجزيرة فِي الْبَحْر. والبضيع: اللَّحْم. قَالَ سَاعِدَة الْهُذلِيّ:\rسادٍ تجَرَّم بالبَضِيعِ ثمانيا\rيُلوِي بِعَيقات البحور ويُجنَبُ\rسادٍ مقلوب من الإسآد، وَهُوَ سَيْر اللَّيْل. تجَرَّم فِي البَضِيع، أَي أَقَامَ فِي الجزيرة. يُلوِي بعَيْقات، أَي يذهب بِمَا فِي ساحات الْبَحْر. ويُجنَب، أَي يُصيبه الجَنوب.\rوَيُقَال جبهتُه تتبضَّع، أَي تسيل عرقاً. قَالَه الأصمعيُّ. وَقَالَ أَبُو ذُؤَيْب:\rإلاّ الحميمَ فَإِنَّهُ يتبضَّعُ\rقَالَ: يتبضَّع: يتفتَّح بالعرق ويسيل متقطِّعاً قَالَ: والبُضَيع: اسْم مَوضِع وَأنْشد لحسان:\rفالبُضَيع فحَوملِ\rوَقَالَ الله: {فَلَبِثَ فِى السِّجْنِ بِضْعَ سِنِينَ} (يُوسُف: ٤٢) قَالَ الْفراء: البِضع: مَا بَين الثَّلَاثَة إِلَى مَا دون الْعشْرَة. وَقَالَ شمر: البِضْع لَا يكون أقلَّ من ثَلَاث وَلَا أكثرَ من عَشرة. وَقَالَ أَبُو زيد: أَقمت عِنْده بِضْع سِنِين. وَقَالَ بَعضهم: بَضْع سِنِين. وَقَالَ أَبُو عُبَيْدَة: البِضْع: مَا لم يبلغ العَقْدَ وَلَا نصفَه، يُرِيد مَا بَين الْوَاحِد إِلَى أَرْبَعَة. وَقَالَ اللَّيْث: البِضْع: مَا بَين ثَلَاثَة إِلَى عشرَة. وَيُقَال الْبضْع سَبْعَة. وَقَالَ أَبُو زيد: يُقَال لَهُ بضعَة وَعِشْرُونَ رجلا وَله بضع وَعِشْرُونَ امْرَأَة.\rوَقَالَ الله عزّ وجلّ: {وَجِئْنَا بِبِضَاعَةٍ مُّزْجَاةٍ} (يُوسُف: ٨٨) البضاعة: السِّلعة، وَأَصلهَا الْقطعَة من المَال الَّذِي يُتْجَر فِيهِ، وَأَصلهَا من البَضْع وَهُوَ القَطْع. وَقَالَ أَبُو الْعَبَّاس: البِضاعة: جُزْء من أَجزَاء المَال. قَالَ: والبِضْع من أربعٍ إِلَى تسع. قَالَ: وَقَالَ الْفراء: يُقَال للسُّيوف بَضَعة وَاحِدهَا باضع وللسِّياط خَضَعة، وَاحِدهَا خاضع. قَالَ: والباضع فِي الْإِبِل مثل الدَّلاّل فِي الدُّور. قَالَ: وَاخْتلف النَّاس فِي البُضْع، فَقَالَ قوم: هُوَ الْفرج، وَقَالَ قوم: هُوَ الْجِمَاع.\rأَبُو عبيد عَن أبي عُبَيْدَة: بضَعتُه بالْكلَام وأبضَعته، وَهُوَ أَن تبيِّن لَهُ مَا تنازعه حتَّى يشتفيَ كَائِنا من كَانَ. وَقَالَ الأصمعيّ: يُقَال مَلك فلانٌ بُضْعَ فُلَانَة، إِذا ملك عُقدَة نِكَاحهَا، وَهُوَ كِنَايَة عَن مَوضِع الغِشْيان. وَقَالَ بعضُهم: ابتضعَ فلانٌ وبَضَع، إِذا تزوَّج. والمباضعة: الْمُبَاشرَة، يُقَال باضَعَها مباضعَةً، إِذا جامَعَها، وَالِاسْم البُضْع.\rاللَّيْث: يُقَال بضعتُه فانبضَع وبَضَع، أَي بيّنته فتبيَّنَ. قَالَ: والباضعة من الْغنم: قطعةٌ انقطعَتْ عَنْهَا، تَقول فِرْقٌ بَواضع.\rأَبُو عبيد عَن الْأَصْمَعِي وَغَيره: الباضعة من الشجاج: الَّتِي تشُجُّ اللَّحْم تَبضَعه بعد الْجلد وَبعد المتلاحِمة.\rأَبُو سعيد: هُوَ شَرِيكي وبَضِيعي، وهم بُضَعائي وشركائي. وَقَالَ أَوْس بن حجر يصف قوساً:\rومَبضوعةً من رأسِ فَرعِ شظيّةٍ\rيَعْنِي قوساً بَضَعَها، أَي قطَعها.',
            ]);

            const segments = segmentPages(pages, options);
            const entrySegments = segments.filter((segment) => !segment.meta?.type);

            expect(entrySegments.some((segment) => segment.meta?.lemma === 'اللَّيْث')).toBeFalse();
            expect(entrySegments.some((segment) => segment.content.startsWith('اللَّيْث:'))).toBeFalse();
        });

        it('should not split on wa-izzah when preceded by jal on the same page', () => {
            initPages(['قول الله جلّ وعزّ: موضع تعظيم.\rوعرض: مدخل صحيح.']);
            ...
            expect(segments[0].content).toContain('جلّ وعزّ:');
            expect(segments[0].meta?.lemma).toBeUndefined();
            expect(segments[1].meta?.lemma).toBe('وعرض');
        });

        it('should split on the huruf', () => {
            initPages([
...
وَقَالَ اللَّيْث: السَّدَرُ: اسْمِدْرَارُ البَصَر،`,
            ...
            const chapterSegment = segments.find((segment) => segment.meta?.type === 'chapter');
            const hurufSegment = segments.find((segment) => segment.meta?.type === 'C' && segment.content === 'س د ر');

            expect(chapterSegment).toBeDefined();
            expect(chapterSegment?.content).toContain('س د ت س د ظ س د ذ س د ث: أهملت وجوهها.');
            expect(hurufSegment).toBeDefined();
        });
    });
    ...
    it('should not merge the page with the next when maxPages=0 and using breakpoint to swallow entire page', () => {
        ...
        initPages([
            'الحمد لله رب العالمين ولا عدوان إلا على الظالمين والعاقبة للمتقين وصلى الله وسلم وبارك على نبينا محمد  والزكوات - والله اعلم - فساد العقيدة كما هو معلوم عادة يؤدي إلى  محمد وعلى آله وصحبه أجمعين',
            'الحمد لله رب العالمين ولا عدوان إلا على الظالمين والعاقبة للمتقين وصلى الله وسلم وبارك على نبينا محمد وعلى آله وصحبه أجمعين أما بعد :فمن خلال مناقشاتي للإباضية الحاقدين الشامتين، أرسل لي أحدهم مقطعاً مصوراً تم نشره منذ سنوات لعضو برلمان سابق وهو  زواج الشاذين كويتيون، لأنهم يستعملون عقود الزواج للحصول على بدل الإجار ،  إشاعة الفاحشة ويحفظ لسانه من نشر الكذب والبهتان .\nوالله المستعان\nوالحمد لله أولاً وآخراً وظاهراً وباطناً وصلى الله وسلم وبارك على نبينا محمد وعلى آله وصحبه أجمعين',
            'الحمد لله رب العالمين ولا عدوان إلا على الظالمين والعاقبة للمتقين وصلى الله وسلم وبارك على نبينا محمد وعلى آله وصحبه اجمعين أما بعد فإن التوراة والإنجيل والقرآن كلها من كتب الله تعالى التي أنزلها الله تعالى أوجب الله تعالى علينا الإيمان بها قال تعالى :(يَا  وَمَلَائِكَتِهِ وَكُتُبِهِ وَرُسُلِهِ وَالْيَوْمِ الْآخِرِ فَقَدْ ضَلَّ ضَلَالًا بَعِيدًا (136) سورة النساء\nولما أنزل كتبه كالتوراة والإنجيل ولم يتكفل بحفظها ولم يشأ ذلك لذلك اعتراها بعض التحريف كما ذكر الله تعالى عن أهل الكتاب فقال :(مِنَ الَّذِينَ هَادُوا يُحَرِّفُونَ الْكَلِمَ عَنْ مَوَاضِعِهِ) (46) سورة   وصلى الله وسلم وبارك على نبينا محمد وعلى آله وصحبه أجمعين.',
        ]);
